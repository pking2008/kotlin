...
private val JvmBuiltinCallLowering = makeJvmPhase(
    { context, file -> JvmBuiltinCallLowering(context).lower(file) },
    name = "JvmBuiltinCallLowering",
    description = "Lower calls of builtin functions"
)
